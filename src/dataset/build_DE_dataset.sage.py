...
# This file was *autogenerated* from the file src/dataset/build_DE_dataset.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_1000 = Integer(1000); _sage_const_3 = Integer(3); _sage_const_10 = Integer(10); _sage_const_100000 = Integer(100000); _sage_const_2 = Integer(2)
import os
import time
import argparse
import numpy as np
...
class ChooseData():
    def __init__(self, tag, F_G_str_list, nvars, field, threshold, timeout, lower_lim_for_num_tokens=None, upper_lim_for_num_tokens=None, n_jobs=-_sage_const_1 , ):
    ...
    def preprocess(self, F_G_str):
        ...
        F_str = F_str.strip()
        G_str = F_G_str.split(':')[_sage_const_1 ]
        G_str = G_str.strip()
    ...
    def get_system_stat(self, P):
        ...
        if field.characteristic() == _sage_const_0 : coeffs = [abs(c) for c in coeffs]
...
class Writer():
    ...
    def preprocess_for_results(self):
        ...
        print('sum runtime (1st ~ 1000th) : ', np.sum(total_time_list[:_sage_const_1000 ]))
        print('\n\n')
...
def get_parser():
    ...
    parser.add_argument("--test_dataset_size", type=int, default=_sage_const_1000 , help="the size of test dataset")
    parser.add_argument("--train_dataset_size", type=int, default=_sage_const_1000 , help="the size of train dataset")
    parser.add_argument("--buchberger_select_strategy", type=str, default='normal', help="Sペアの選択戦略")
    parser.add_argument("--buchberger_train_timeout", type=float, default=_sage_const_10 , help="buchbergerアルゴリズムのタイムアウト")
    parser.add_argument("--buchberger_test_timeout", type=float, default=_sage_const_10 , help="buchbergerアルゴリズムのタイムアウト")
